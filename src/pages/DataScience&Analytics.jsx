...
const benefits = [
  {
    title: "data.benefit1.title",
    description: "data.benefit1.desc",
  },
  {
    title: "data.benefit2.title",
    description: "data.benefit2.desc",
  },
  {
    title: "data.benefit3.title",
    description: "data.benefit3.desc",
  },
  {
    title: "data.benefit4.title",
    description: "data.benefit4.desc",
  },
  {
    title: "data.benefit5.title",
    description: "data.benefit5.desc",
  },
  {
    title: "data.benefit6.title",
    description: "data.benefit6.desc",
  },
];
const steps = [
  "data.step1",
        ...
        <div className="grid items-center gap-12 px-6 mx-auto max-w-7xl md:grid-cols-2">
          ...
          <div data-aos="fade-right" data-aos-delay="460">
            ...
            <p
              ...
              style={{ color: theme === "dark" ? "#ddd" : "#444" }}
            >
              {t("data.whyChoose.desc3")}
            </p>
            <p
              className="mb-6 leading-relaxed text-justify"
              style={{ color: theme === "dark" ? "#ddd" : "#444" }}
            >
              {t("data.whyChoose.desc4")}
            </p>
            <p
              className="leading-relaxed text-justify"
              style={{ color: theme === "dark" ? "#ddd" : "#444" }}
            >
              {t("data.whyChoose.desc5")}
            </p>
          </div>
              ...
              >
                <tr>
                  <th className="px-4 py-3">
                    {t("data.costGuide.table.floorArea")}
                  </th>
                  <th className="px-4 py-3">
                    {t("data.costGuide.table.interiorStyle")}
                  </th>
                  <th className="px-4 py-3">
                    {t("data.costGuide.table.estimatedCost")}
                  </th>
                  <th className="px-4 py-3">
                    {t("data.costGuide.table.timeline")}
                  </th>
                  <th className="px-4 py-3">
                    {t("data.costGuide.table.keyInclusions")}
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                >
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row1.area")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row1.style")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row1.cost")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row1.timeline")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row1.inclusions")}
                  </td>
                </tr>
                <tr
                ...
                >
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row2.area")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row2.style")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row2.cost")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row2.timeline")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row2.inclusions")}
                  </td>
                </tr>
                <tr
                  className={`${theme === "dark" ? "bg-black text-gray-300" : "bg-white"}`}
                >
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row3.area")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row3.style")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row3.cost")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row3.timeline")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row3.inclusions")}
                  </td>
                </tr>
                <tr
                  className={`${theme === "dark" ? "bg-gray-900 text-gray-300" : "bg-gray-100"}`}
                >
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row4.area")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row4.style")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row4.cost")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row4.timeline")}
                  </td>
                  <td className="px-4 py-3">
                    {t("data.costGuide.table.row4.inclusions")}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div data-aos="fade-up" data-aos-delay="760">
            ...
            >
              <li className="grid grid-cols-[auto_1fr] gap-2">
                ...
                {t("data.caseStudy.point1")}
              </li>
              <li className="grid grid-cols-[auto_1fr] gap-2">
                <span className="text-yellow-400">•</span>
                {t("data.caseStudy.point2")}
              </li>
              <li className="grid grid-cols-[auto_1fr] gap-2">
                <span className="text-yellow-400">•</span>
                {t("data.caseStudy.point3")}
              </li>
            </ul>
          </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900">
                {t("data.pricing.basic.title")}
              </h3>
              <p className="mt-2 text-xl font-semibold text-gray-800">
                {t("data.pricing.basic.price")}
              </p>
            </div>
            <ul
              className={`p-6 flex-1 space-y-4 text-base leading-relaxed ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}
            >
              <li>{t("data.pricing.basic.feature1")}</li>
              <li>{t("data.pricing.basic.feature2")}</li>
              <li>{t("data.pricing.basic.feature3")}</li>
              <li>{t("data.pricing.basic.feature4")}</li>
            </ul>
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900">
                {t("data.pricing.premium.title")}
              </h3>
              <p className="mt-2 text-xl font-semibold text-gray-900">
                {t("data.pricing.premium.price")}
              </p>
            </div>
            <ul
              className={`p-6 flex-1 space-y-4 text-base leading-relaxed ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}
            >
              <li>{t("data.pricing.premium.feature1")}</li>
              <li>{t("data.pricing.premium.feature2")}</li>
              <li>{t("data.pricing.premium.feature3")}</li>
              <li>{t("data.pricing.premium.feature4")}</li>
            </ul>
            <div className="p-6 text-center">
              <button className="px-6 py-3 font-semibold text-gray-900 transition duration-300 bg-yellow-400 shadow rounded-xl hover:bg-yellow-300">
                {t("data.pricing.choose")}
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900">
                {t("data.pricing.luxury.title")}
              </h3>
              <p className="mt-2 text-xl font-semibold text-gray-800">
                {t("data.pricing.luxury.price")}
              </p>
            </div>
            <ul
              className={`p-6 flex-1 space-y-4 text-base leading-relaxed ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}
            >
              <li>{t("data.pricing.luxury.feature1")}</li>
              <li>{t("data.pricing.luxury.feature2")}</li>
              <li>{t("data.pricing.luxury.feature3")}</li>
              <li>{t("data.pricing.luxury.feature4")}</li>
            </ul>
            <div className="p-6 text-center">
              <button className="px-6 py-3 font-semibold text-gray-900 transition duration-300 bg-yellow-400 shadow rounded-xl hover:bg-yellow-300">
                {t("data.pricing.choose")}
