...
import a1 from "../assets/ren1.png";
import a2 from "../assets/ren2.jpg";

// Use translation keys for benefits and steps (renovation namespace)
const benefitKeys = [
  { title: "renovation.benefit1.title", desc: "renovation.benefit1.desc" },
  { title: "renovation.benefit2.title", desc: "renovation.benefit2.desc" },
  { title: "renovation.benefit3.title", desc: "renovation.benefit3.desc" },
  { title: "renovation.benefit4.title", desc: "renovation.benefit4.desc" },
  { title: "renovation.benefit5.title", desc: "renovation.benefit5.desc" },
  { title: "renovation.benefit6.title", desc: "renovation.benefit6.desc" },
];
const stepKeys = [
  "renovation.step1",
  "renovation.step2",
      ...
      >
        ...
        >
          <h2
            ...
            data-aos-delay="640"
          >
            {t("renovation.costEstimator.title")}
          </h2>
          <p
            ...
            data-aos-delay="660"
          >
            {t("renovation.costEstimator.desc")}
          </p>
        ...
        ${theme === "dark" ? "border-gray-700" : "border-gray-300"}`}
              ...
              >
                <tr>
                  <th className="px-4 py-3">
                    {t("renovation.costEstimator.table.floorArea")}
                  </th>
                  <th className="px-4 py-3">
                    {t("renovation.costEstimator.table.interiorStyle")}
                  </th>
                  <th className="px-4 py-3">
                    {t("renovation.costEstimator.table.estimatedCost")}
                  </th>
                  <th className="px-4 py-3">
                    {t("renovation.costEstimator.table.timeline")}
                  </th>
                  <th className="px-4 py-3">
                    {t("renovation.costEstimator.table.keyInclusions")}
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                >
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row1.area")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row1.style")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row1.cost")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row1.timeline")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row1.inclusions")}
                  </td>
                </tr>
                <tr
                ...
                >
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row2.area")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row2.style")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row2.cost")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row2.timeline")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row2.inclusions")}
                  </td>
                </tr>
                <tr
                  className={`${theme === "dark" ? "bg-black text-gray-300" : "bg-white"}`}
                >
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row3.area")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row3.style")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row3.cost")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row3.timeline")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row3.inclusions")}
                  </td>
                </tr>
                <tr
                  className={`${theme === "dark" ? "bg-gray-900 text-gray-300" : "bg-gray-100"}`}
                >
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row4.area")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row4.style")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row4.cost")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row4.timeline")}
                  </td>
                  <td className="px-4 py-3">
                    {t("renovation.costEstimator.table.row4.inclusions")}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <p
            ...
            data-aos-delay="700"
          >
            {t("renovation.costEstimator.note")}
          </p>
        </div>
      </section>
        ...
        <div className="grid items-center gap-12 px-4 mx-auto max-w-7xl sm:px-6 md:grid-cols-2 md:gap-16">
          ...
          <div data-aos="fade-up" data-aos-delay="760">
            <h2 className="mb-4 text-3xl font-bold leading-snug text-yellow-400 sm:text-4xl md:text-5xl sm:mb-6">
              {t("renovation.caseStudy.title")}
            </h2>
            <h2 className="mb-4 text-3xl font-bold leading-snug text-yellow-400 sm:text-4xl md:text-5xl sm:mb-6">
              {t("renovation.caseStudy.subtitle")}
            </h2>
            ...
            >
              <li className="grid grid-cols-[auto_1fr] gap-2">
                ...
                {t("renovation.caseStudy.point1")}
              </li>
              <li className="grid grid-cols-[auto_1fr] gap-2">
                <span className="text-yellow-400">•</span>
                {t("renovation.caseStudy.point2")}
              </li>
              <li className="grid grid-cols-[auto_1fr] gap-2">
                <span className="text-yellow-400">•</span>
                {t("renovation.caseStudy.point3")}
              </li>
            </ul>
          </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900">
                {t("renovation.pricing.basic.title")}
              </h3>
              <p className="mt-2 text-xl font-semibold text-gray-800">
                {t("renovation.pricing.basic.price")}
              </p>
            </div>
            <ul
              className={`p-6 flex-1 space-y-4 text-base leading-relaxed ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}
            >
              <li>{t("renovation.pricing.basic.feature1")}</li>
              <li>{t("renovation.pricing.basic.feature2")}</li>
              <li>{t("renovation.pricing.basic.feature3")}</li>
              <li>{t("renovation.pricing.basic.feature4")}</li>
            </ul>
            <div className="p-6 text-center">
              <button className="px-6 py-3 font-semibold text-gray-900 transition duration-300 bg-yellow-400 shadow rounded-xl hover:bg-yellow-300">
                {t("renovation.pricing.choosePlan")}
              </button>
            </div>
          </div>
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900">
                {t("renovation.pricing.premium.title")}
              </h3>
              <p className="mt-2 text-xl font-semibold text-gray-900">
                {t("renovation.pricing.premium.price")}
              </p>
            </div>
            <ul
              className={`p-6 flex-1 space-y-4 text-base leading-relaxed ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}
            >
              <li>{t("renovation.pricing.premium.feature1")}</li>
              <li>{t("renovation.pricing.premium.feature2")}</li>
              <li>{t("renovation.pricing.premium.feature3")}</li>
              <li>{t("renovation.pricing.premium.feature4")}</li>
            </ul>
            <div className="p-6 text-center">
              <button className="px-6 py-3 font-semibold text-gray-900 transition duration-300 bg-yellow-400 shadow rounded-xl hover:bg-yellow-300">
                {t("renovation.pricing.choosePlan")}
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900">
                {t("renovation.pricing.luxury.title")}
              </h3>
              <p className="mt-2 text-xl font-semibold text-gray-800">
                {t("renovation.pricing.luxury.price")}
              </p>
            </div>
            <ul
              className={`p-6 flex-1 space-y-4 text-base leading-relaxed ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}
            >
              <li>{t("renovation.pricing.luxury.feature1")}</li>
              <li>{t("renovation.pricing.luxury.feature2")}</li>
              <li>{t("renovation.pricing.luxury.feature3")}</li>
              <li>{t("renovation.pricing.luxury.feature4")}</li>
            </ul>
            <div className="p-6 text-center">
              <button className="px-6 py-3 font-semibold text-gray-900 transition duration-300 bg-yellow-400 shadow rounded-xl hover:bg-yellow-300">
                {t("renovation.pricing.choosePlan")}
